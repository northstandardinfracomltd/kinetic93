...
export const INITIAL_TICKETS: SupportTicket[] = [
  {
    id: '00001-DEMO-0926',
    reference: '00001-DEMO-0926',
    identifiant: '00001-DEMO-0926',
    categorie: 'Technique',
    situation: 'Nouveau',
    status: 'Nouveau',
    criticite: 'Urgent',
    dateOuverture: '07/09/2026',
    dateDerniereActualisation: '07/09/2026',
    objet: 'Électrode périmée sur défibrillateur hall',
    collaborateur: 'Alexandre Martin',
    client: 'Clinique Saint-Martin',
    description: "Le voyant d'état clignote en rouge. Les électrodes adultes doivent être remplacées en urgence suite au contrôle trimestriel de sécurité. Merci de planifier le passage d'un technicien dès aujourd'hui.",
  },
  {
    id: '00002-DEMO-0926',
    reference: '00002-DEMO-0926',
    identifiant: '00002-DEMO-0926',
    categorie: 'Commercial',
    situation: 'En cours',
    status: 'En cours',
    criticite: 'Semaine prochaine',
    dateOuverture: '05/09/2026',
    dateDerniereActualisation: '07/09/2026',
    objet: 'Demande de devis pour 2 DAE supplémentaires',
    collaborateur: 'Sophie Bernard',
    client: 'Mairie de Bordeaux',
    description: "Le responsable des bâtiments municipaux souhaite équiper la salle des fêtes et le complexe sportif avant le 15 septembre. Un devis incluant l'installation murale et le kit de secours est requis.",
  },
  {
    id: '00003-DEMO-0926',
    reference: '00003-DEMO-0926',
    identifiant: '00003-DEMO-0926',
    categorie: 'Réclamation',
    situation: 'Nouveau',
    status: 'Nouveau',
    criticite: 'Ce mois',
    dateOuverture: '03/09/2026',
    dateDerniereActualisation: '06/09/2026',
    objet: 'Batterie faible signalée lors du contrôle',
    collaborateur: 'Thomas Dubois',
    client: 'Hôtel du Parc',
    description: "La batterie du défibrillateur situé au 1er étage indique une charge inférieure à 20%. Remplacement à prévoir avant la fin du mois dans le cadre du contrat de maintenance préventive.",
  },
  {
    id: '00004-DEMO-0926',
    reference: '00004-DEMO-0926',
    identifiant: '00004-DEMO-0926',
    categorie: 'Technique',
    situation: 'En cours',
    status: 'En cours',
    criticite: 'Mois prochain',
    dateOuverture: '01/09/2026',
    dateDerniereActualisation: '04/09/2026',
    objet: 'Contrôle annuel préventif et mise à jour firmware',
    collaborateur: 'Alexandre Martin',
    client: 'Centre Sportif Océan',
    description: "Planification de la visite d'inspection annuelle réglementaire pour les 3 appareils du site. Vérification des autotests, étalonnage des capteurs et remplacement des consommables arrivant à échéance.",
  },
  {
    id: '00005-DEMO-0926',
    reference: '00005-DEMO-0926',
    identifiant: '00005-DEMO-0926',
    categorie: 'Sans Catégorie',
    situation: 'Terminé',
    status: 'Résolu',
    criticite: 'Non renseigné',
    dateOuverture: '28/08/2026',
    dateDerniereActualisation: '02/09/2026',
    objet: 'Question sur le registre de sécurité incendie et DAE',
    collaborateur: 'Sophie Bernard',
    client: 'Société Générale de Distribution',
    description: "Le client a sollicité notre assistance pour la mise en conformité de son registre de sécurité dématérialisé. Les documents de conformité ont été transmis avec succès.",
  }
];
